  ...
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
        ...
        <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid exercitationem possimus magni nam iste. Sit facilis reiciendis laboriosam vero esse illum corporis quo illo harum possimus doloremque, placeat saepe repellat?
        </p>
    </div>
  )
}
