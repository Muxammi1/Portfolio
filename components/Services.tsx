...
const Services = () => {
  return (
    <div className='bg-[#121212] pt-[4rem] md:pt-[8rem] pb-[5rem]'>
        <p className='heading '>
            My <span className='text-[#008080]'>Services</span>
        </p>
            ...
            <div data-aos='fade-right'>
                <div className='bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]'>
                    ...
                    <p className='text-[15px] text-[#d3d2d2] font-normal'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem hic perspiciatis culpa, laudantium odit obcaecati molestias minima! Suscipit, perferendis atque pariatur laboriosam mollitia error iste obcaecati, temporibus magnam eligendi consequatur?
                    </p>
                </div>
            </div>
