...
const About = () => {
  return (
    <div className='bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]'>
        <div className='grid grid-cols-2 md:grid-col-1 w-[80%] mx-auto gap-[3rem] items-center'>
            <div>
                <h1 className='text-[20px] font-bold uppercase text-[#55e6a5] mb-[1rem]'>ABOUT ME</h1>
                <h2 className='text-[25px] md:text-[35px] lg:text-[45px] md:leading-[3rem] leading-[2rem] capitalize mb-[3rem] font-bold text-white'>
                    Transforming <span className='text-[#008080]'>Visions</span>
                </h2>
                <div className='mb-[3rem] flex items-center md:space-x-10'>
                    <span className='w-[100px] hidden md:block h-[5px] bg-slate-400 rounded-sm'></span>
                    <p className='text-[19px] text-slate-400 w-[80%]'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        Expedita amet dolor incidunt quos itaque dignissimos eos atque.
                        Quis nulla libero, quisquam fugit, harum reiciendis iste suscipit perspiciatis autem sunt corrupti.
                    </p>
                </div>
